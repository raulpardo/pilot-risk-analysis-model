...
#define _nstates10	11	/* can_carinsure_use_for_profiling */
#define minseq10	1088
#define maxseq10	1097
#define _endstate10	10

#define _nstates9	11	/* transfer_to_parketww_according_to_policy */
#define minseq9	1078
#define maxseq9	1087
...
#define _nstates2	645	/* deviceDC */
#define minseq2	374
#define maxseq2	1017
#define _endstate2	644
...
typedef struct P10 { /* can_carinsure_use_for_profiling */
...
typedef struct P9 { /* transfer_to_parketww_according_to_policy */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
