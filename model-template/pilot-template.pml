...
inline policy_generator(p_entity, p_purpose, result_policy) {
		...
		/*TRANSFER RULES*/
		/*TRANSFER RULE 1*/
		{{tr0}}result_policy.tr[0].condition = true;
		{{tr0}}result_policy.tr[0].entity = {{tr0Entity}};
		{{tr0}}result_policy.tr[0].dur.purpose = {{tr0Purpose}};
		{{tr0}}result_policy.tr[0].dur.retention_time = 42;
		/*TRANSFER RULE 2*/
		{{tr1}}result_policy.tr[1].condition = true;
		{{tr1}}result_policy.tr[1].entity = {{tr1Entity}};
		{{tr1}}result_policy.tr[1].dur.purpose = {{tr1Purpose}};
		{{tr1}}result_policy.tr[1].dur.retention_time = 42;
};
...
init {
		...
		Policy p1;
		policy_generator({{collectionEntity}},{{collectionPurpose}},p1);
...
proctype deviceDC(mtype p_entity) {
		...
		/*************************/
		bool enabled_illegal_transfer = {{illegalTransferParketWW}};
		bool enabled_illegal_use = {{illegalUseCarInsure}};
		/**************************************/
