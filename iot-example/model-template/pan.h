...
#define _nstates12	11	/* can_carinsure_use_for_profiling */
#define minseq12	1097
#define maxseq12	1106
#define _endstate12	10

#define _nstates11	11	/* transfer_to_parketww_according_to_policy */
#define minseq11	1087
#define maxseq11	1096
#define _endstate11	10

#define _nstates10	11	/* can_parketww_use_for_commercial_offers */
#define minseq10	1077
#define maxseq10	1086
#define _endstate10	10

#define _nstates9	11	/* can_parket_use_for_commercial_offers */
#define minseq9	1067
#define maxseq9	1076
#define _endstate9	10

#define _nstates8	11	/* collection_carinsure_according_to_policy */
#define minseq8	1057
#define maxseq8	1066
#define _endstate8	10

#define _nstates7	11	/* collection_parketww_according_to_policy */
#define minseq7	1047
#define maxseq7	1056
#define _endstate7	10

#define _nstates6	11	/* collection_parket_according_to_policy */
#define minseq6	1037
#define maxseq6	1046
#define _endstate6	10

#define _nstates5	11	/* never_reaches_carinsure */
#define minseq5	1027
#define maxseq5	1036
#define _endstate5	10

#define _nstates4	11	/* never_reaches_parketww */
#define minseq4	1017
#define maxseq4	1026
#define _endstate4	10

#define _nstates3	11	/* never_reaches_parket */
#define minseq3	1007
#define maxseq3	1016
#define _endstate3	10

#define _nstates2	638	/* deviceDC */
#define minseq2	370
#define maxseq2	1006
#define _endstate2	637

#define _nstates1	279	/* deviceAlice */
#define minseq1	92
#define maxseq1	369
#define _endstate1	278

#define _nstates0	93	/* :init: */
#define minseq0	0
#define maxseq0	91
#define _endstate0	92
...
struct DUR { /* user defined type */
	uchar purpose;
	int retention_time;
};
struct DCR { /* user defined type */
...
struct Item { /* user defined type */
	uchar item_id;
	uchar owner;
	uchar datatype;
};
struct DatabaseEntry { /* user defined type */
	uchar device;
	struct Item item;
	uchar value;
};
struct ReceivedDataEntry { /* user defined type */
	uchar device;
	uchar sender;
	uchar item_id;
	struct Policy policy;
};
struct PolicyBaseEntry { /* user defined type */
	uchar device;
	uchar owner;
	struct Policy policy;
};
typedef struct P12 { /* can_carinsure_use_for_profiling */
...
typedef struct P11 { /* transfer_to_parketww_according_to_policy */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P10 { /* can_parketww_use_for_commercial_offers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P9 { /* can_parket_use_for_commercial_offers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P8 { /* collection_carinsure_according_to_policy */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* collection_parketww_according_to_policy */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P6 { /* collection_parket_according_to_policy */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* never_reaches_carinsure */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* never_reaches_parketww */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* never_reaches_parket */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
...
#define PdeviceDC	((P2 *)this)
typedef struct P2 { /* deviceDC */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned enabled_illegal_transfer : 1;
	unsigned enabled_illegal_use : 1;
	unsigned _11_6_11_data_received : 1;
	unsigned _11_6_11_active_tr : 1;
	unsigned _11_6_11_active_p1 : 1;
	unsigned _11_6_11_15_activeP : 1;
	unsigned _11_6_11_result1 : 1;
	unsigned _11_6_11_17_purpose_dcr : 1;
	unsigned _11_6_11_17_17_purpose_tr : 1;
	unsigned _11_6_11_19_result : 1;
	unsigned _11_7_12_data_received : 1;
	unsigned _11_7_12_result2 : 1;
	unsigned _11_7_12_23_result : 1;
	unsigned _11_8_r_result : 1;
	uchar _11_5_l;
	uchar _11_5_10_index;
	uchar _11_5_10_8_i;
	uchar _11_5_10_9_i;
	uchar _11_5_10_9_k;
	uchar _11_5_10_j;
	...
	uchar _11_6_11_k;
	uchar _11_6_11_17_l;
	uchar _11_6_11_17_ok_transfer;
	uchar _11_6_11_18_l;
	uchar _11_6_11_19_20_i;
	uchar _11_7_db_index;
	uchar _11_7_12_21_i;
	uchar _11_7_12_21_j;
	uchar _11_7_12_22_l;
	uchar _11_7_12_23_25_i;
	uchar _11_8_13_24_i;
	uchar p_entity;
	uchar request_target;
	uchar transfer_target;
	uchar _11_6_11_result2;
	uchar _11_7_target_entity;
	uchar _11_7_12_data_defined;
	uchar _11_8_illegal_purpose;
	int _11_6_11_12_i;
	int _11_6_11_19_19_i;
	int _11_7_12_20_i;
	int _11_7_12_23_24_i;
	struct Policy _11_5_rand_pol;
	struct Policy _11_6_11_r_received_policy;
	struct Policy _11_6_11_r_policy;
	struct Policy _11_6_11_constr_sender;
	struct Policy _11_7_12_r_received_policy;
} P2;
#define Air2	0

#define PdeviceAlice	((P1 *)this)
typedef struct P1 { /* deviceAlice */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 11; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned _10_4_5_active_p1 : 1;
	unsigned _10_4_5_active_p2 : 1;
	unsigned _10_4_5_2_activeP : 1;
	unsigned _10_4_5_3_activeP : 1;
	unsigned _10_4_5_result1 : 1;
	unsigned _10_4_5_4_purpose_dcr : 1;
	unsigned _10_4_5_4_6_purpose_tr : 1;
	unsigned _10_4_5_7_result : 1;
	uchar _10_4_5_2_l;
	uchar _10_4_5_2_k;
	uchar _10_4_5_3_l;
	uchar _10_4_5_3_k;
	uchar _10_4_5_4_l;
	uchar _10_4_5_4_ok_transfer;
	uchar _10_4_5_j;
	uchar _10_4_5_6_l;
	uchar _10_4_5_7_9_i;
	uchar target;
	uchar _10_4_5_result2;
	int _10_4_5_1_i;
	int _10_4_5_7_8_i;
	struct Policy _10_4_5_sender_p;
	struct Policy _10_4_5_receiver_p;
	struct Policy _10_4_5_pol;
} P1;
#define Air1	0
...
typedef struct P14 {
	...
	unsigned _p   : 11; /* active-claim state */
...
typedef struct State {
	...
	#endif
#endif
	uchar database_index;
	uchar received_data_index;
	struct DatabaseEntry database[5];
	struct ReceivedDataEntry received_data[5];
	struct PolicyBaseEntry policy_base[5];
#ifdef TRIX
...
#else
	#define ACCEPT_LAB	10 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
